...
`tmp/afd_summary_all_datasets_coverage_10_30_50_70_90.csv` is the main cross-dataset summary used by `generate_dissertation_figures.py`. The `clean_final_*_afd_table.csv` files are presentation-ready subsets for PathVQA and ProstateMM/CHIMERA.
